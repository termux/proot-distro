...
write_plugin() {
	...
	TARBALL_URL['armv7']="${GIT_RELEASE_URL}/adelie-armv7-pd-${CURRENT_VERSION}.tar.xz"
	TARBALL_SHA256['armv7']="$(sha256sum "${ROOTFS_DIR}/adelie-armv7-pd-${CURRENT_VERSION}.tar.xz" | awk '{ print $1}')"
