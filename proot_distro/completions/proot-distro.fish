...
complete -c pd -f -n '__fish_seen_subcommand_from login' -l user           -r -d 'Run as this user'
complete -c pd -f -n '__fish_seen_subcommand_from login' -l redirect-ports    -d 'Redirect ports below 1024'
...
complete -c pd -n   '__fish_seen_subcommand_from login' -l bind            -r -d 'Bind-mount path (repeatable)'
...
complete -c pd -n   '__fish_seen_subcommand_from login' -l work-dir         -r -d 'Working directory'
complete -c pd -f -n '__fish_seen_subcommand_from login' -l env             -r -d 'Environment variable'
