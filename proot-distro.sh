...
setup_fake_proc() {
	...
	if [ ! -f "${INSTALLED_ROOTFS_DIR}/${distro_name}/proc/.stat" ]; then
 		echo '
H4sIAAAAAAAAA+2UYWrDMAyF/+cU7wiWZFn2aQbNshG2pV2SQo8/yWvKrjAoguCHPj/J+fHGyxWg
poYErmZowtWPhSGZwZpRo5eG8XJNEAqOC4gTGyqDEjLaQRCy+rmUDCLKGUzuJWARv3JQjNyyCxVz
jKv3LYwE9UAEouHKEk7GjrhZgeKxjesWw7jUQKzv4kP4zyR15xSMkjM1tlAfQ4HekYIsIZT9Nkkt
...
PZ3MIjo4e1b5iB5zVMyGHzaioC2wBQAA
   ' | base64 -d | gzip -d > "${INSTALLED_ROOTFS_DIR}/${distro_name}/proc/.stat"
	...
	if [ ! -f "${INSTALLED_ROOTFS_DIR}/${distro_name}/proc/.vmstat" ]; then
  		echo '

' | base64 -d | gzip -d > "${INSTALLED_ROOTFS_DIR}/${distro_name}/proc/.vmstat"
	fi
