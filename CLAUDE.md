...
| `helpers/rootfs.py` | Install helpers: `write_environment()`, `fix_path_in_configs()`, `write_resolv_conf()`, `write_hosts()`, `register_android_ids()` |
...
4. **After layer application**: `write_environment`, `fix_path_in_configs`, `write_resolv_conf`, `write_hosts`, `register_android_ids`, `setup_fake_sysdata` are run.
